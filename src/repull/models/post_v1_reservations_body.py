...
T = TypeVar("T", bound="PostV1ReservationsBody")



@_attrs_define
class PostV1ReservationsBody:
    """ 
        Attributes:
            property_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_v1_reservations_body.additional_properties = d
        return post_v1_reservations_body
