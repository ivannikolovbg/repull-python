...
from ..models.migration_failed_event_event import MigrationFailedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.migration_import_payload import MigrationImportPayload
...
T = TypeVar("T", bound="MigrationFailedEvent")



@_attrs_define
class MigrationFailedEvent:
    """ An import into a migration workspace stopped with an error.

        Attributes:
            event (MigrationFailedEventEvent): The event name. This field is `event`, not `type`.
            ...
            workspace_id (int): The migration's workspace — pass it as `X-Workspace-Id`, or to `GET
                /v1/migrations/{workspaceId}`.
            data (MigrationImportPayload): One import run into a migration workspace.
    ...
    event: MigrationFailedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = MigrationFailedEventEvent(d.pop("event"))
        ...
        data = MigrationImportPayload.from_dict(d.pop("data"))
        ...
        migration_failed_event.additional_properties = d
        return migration_failed_event
