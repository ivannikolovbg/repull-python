...
from ..models.inquiry_updated_event_event import InquiryUpdatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.inquiry_updated_payload import InquiryUpdatedPayload
...
T = TypeVar("T", bound="InquiryUpdatedEvent")



@_attrs_define
class InquiryUpdatedEvent:
    """ 
        Attributes:
            event (InquiryUpdatedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: InquiryUpdatedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: InquiryUpdatedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = InquiryUpdatedEventEvent(d.pop("event"))
        ...
        data = InquiryUpdatedPayload.from_dict(d.pop("data"))
        ...
        inquiry_updated_event.additional_properties = d
        return inquiry_updated_event
