...
T = TypeVar("T", bound="GetAirbnbBookingSettingsResponse200DataBookingWindow")



@_attrs_define
class GetAirbnbBookingSettingsResponse200DataBookingWindow:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_airbnb_booking_settings_response_200_data_booking_window = cls(
            days=days,
            unlimited=unlimited,
        )


        get_airbnb_booking_settings_response_200_data_booking_window.additional_properties = d
        return get_airbnb_booking_settings_response_200_data_booking_window
