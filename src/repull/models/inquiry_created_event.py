...
from ..models.inquiry_created_event_event import InquiryCreatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.inquiry_created_payload import InquiryCreatedPayload
...
T = TypeVar("T", bound="InquiryCreatedEvent")



@_attrs_define
class InquiryCreatedEvent:
    """ 
        Attributes:
            event (InquiryCreatedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (InquiryCreatedPayload): Payload for `inquiry.created`. A guest asked about dates.
    ...
    event: InquiryCreatedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: InquiryCreatedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = InquiryCreatedEventEvent(d.pop("event"))
        ...
        data = InquiryCreatedPayload.from_dict(d.pop("data"))
        ...
        inquiry_created_event.additional_properties = d
        return inquiry_created_event
