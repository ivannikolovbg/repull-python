...
T = TypeVar("T", bound="GetAirbnbThreadResponse200")



@_attrs_define
class GetAirbnbThreadResponse200:
    """ 
        Attributes:
            data (AirbnbThread): An Airbnb message thread.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.airbnb_thread import AirbnbThread
        d = dict(src_dict)
        data = AirbnbThread.from_dict(d.pop("data"))
        ...
        get_airbnb_thread_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        get_airbnb_thread_response_200.additional_properties = d
        return get_airbnb_thread_response_200
