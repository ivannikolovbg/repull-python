...
from ..models.update_airbnb_booking_settings_response_200_data_settings_instant_book_guest_category import UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBookGuestCategory
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBook")



@_attrs_define
class UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBook:
    """ Instant Book state. All three fields describe ONE Airbnb value, `instant_booking_allowed_category`.
        ...
        Attributes:
            ...
            guest_category (UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBookGuestCategory | Unset): Which
                guests may Instant Book.
    ...
    guest_category: UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBookGuestCategory | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        guest_category: UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBookGuestCategory | Unset
        if isinstance(_guest_category,  Unset):
            guest_category = UNSET
        else:
            guest_category = UpdateAirbnbBookingSettingsResponse200DataSettingsInstantBookGuestCategory(_guest_category)
        ...
        update_airbnb_booking_settings_response_200_data_settings_instant_book = cls(
            enabled=enabled,
        ...
        update_airbnb_booking_settings_response_200_data_settings_instant_book.additional_properties = d
        return update_airbnb_booking_settings_response_200_data_settings_instant_book
