...
from ..models.usage_quota_warning_event_event import UsageQuotaWarningEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.usage_quota_warning_payload import UsageQuotaWarningPayload
...
T = TypeVar("T", bound="UsageQuotaWarningEvent")



@_attrs_define
class UsageQuotaWarningEvent:
    """ 
        Attributes:
            event (UsageQuotaWarningEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (UsageQuotaWarningPayload): Payload for `usage.quota.warning`. Sent once per account per window when usage
                crosses 80% of a request quota — a heads-up, not a refusal. `topOperation` names the operation driving the
                traffic so a runaway loop can be found before the cap stops it.
    ...
    event: UsageQuotaWarningEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: UsageQuotaWarningPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = UsageQuotaWarningEventEvent(d.pop("event"))
        ...
        data = UsageQuotaWarningPayload.from_dict(d.pop("data"))
        ...
        usage_quota_warning_event.additional_properties = d
        return usage_quota_warning_event
