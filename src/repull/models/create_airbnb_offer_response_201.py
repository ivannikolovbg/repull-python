...
from ..models.create_airbnb_offer_response_201_offer_type import CreateAirbnbOfferResponse201OfferType
from ..models.create_airbnb_offer_response_201_status import CreateAirbnbOfferResponse201Status
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.create_airbnb_offer_response_201_guest_details import CreateAirbnbOfferResponse201GuestDetails





T = TypeVar("T", bound="CreateAirbnbOfferResponse201")



@_attrs_define
class CreateAirbnbOfferResponse201:
    ...
    carries only the thread, status and expiry.
        ...
        Attributes:
            ...
            offer_type (CreateAirbnbOfferResponse201OfferType | Unset):
            status (CreateAirbnbOfferResponse201Status | Unset):
            listing_id (str | Unset): Airbnb listing id (special offers only).
            start_date (datetime.date | Unset):
            nights (int | Unset):
            total_price (float | Unset):
            guest_details (CreateAirbnbOfferResponse201GuestDetails | Unset):
    ...
    offer_type: CreateAirbnbOfferResponse201OfferType | Unset = UNSET
    status: CreateAirbnbOfferResponse201Status | Unset = UNSET
    listing_id: str | Unset = UNSET
    start_date: datetime.date | Unset = UNSET
    nights: int | Unset = UNSET
    total_price: float | Unset = UNSET
    guest_details: CreateAirbnbOfferResponse201GuestDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_offer_type,  Unset):
            ...
            offer_type = CreateAirbnbOfferResponse201OfferType(_offer_type)
        ...
        if isinstance(_status,  Unset):
            ...
            status = CreateAirbnbOfferResponse201Status(_status)
        ...
        if isinstance(_guest_details,  Unset):
            ...
            guest_details = CreateAirbnbOfferResponse201GuestDetails.from_dict(_guest_details)
        ...
        create_airbnb_offer_response_201 = cls(
            id=id,
            thread_id=thread_id,
        ...
        create_airbnb_offer_response_201.additional_properties = d
        return create_airbnb_offer_response_201
