...
from ..models.account_created_event_event import AccountCreatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.account_created_payload import AccountCreatedPayload
...
T = TypeVar("T", bound="AccountCreatedEvent")
...
class AccountCreatedEvent:
    """ 
        Attributes:
            event (AccountCreatedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (AccountCreatedPayload): Payload for `account.created`. An OAuth or API credential connection was completed
                by an end user.
    ...
    event: AccountCreatedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = AccountCreatedEventEvent(d.pop("event"))
        ...
        data = AccountCreatedPayload.from_dict(d.pop("data"))
        ...
        account_created_event.additional_properties = d
