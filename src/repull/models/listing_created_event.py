...
from ..models.listing_created_event_event import ListingCreatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.listing_created_payload import ListingCreatedPayload
...
T = TypeVar("T", bound="ListingCreatedEvent")
...
class ListingCreatedEvent:
    """ 
        Attributes:
            event (ListingCreatedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (ListingCreatedPayload): Payload for `listing.created`. A new property was synced into Repull from a
                connected PMS or channel.
    ...
    event: ListingCreatedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ListingCreatedEventEvent(d.pop("event"))
        ...
        data = ListingCreatedPayload.from_dict(d.pop("data"))
        ...
        listing_created_event.additional_properties = d
        return listing_created_event
