...
if TYPE_CHECKING:
  ...
  from ..models.airbnb_safety_disclosures_response import AirbnbSafetyDisclosuresResponse





T = TypeVar("T", bound="ListAirbnbListingSafetyDisclosuresResponse200")



@_attrs_define
class ListAirbnbListingSafetyDisclosuresResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.airbnb_safety_disclosures_response import AirbnbSafetyDisclosuresResponse
        d = dict(src_dict)
        data = AirbnbSafetyDisclosuresResponse.from_dict(d.pop("data"))
        ...
        list_airbnb_listing_safety_disclosures_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        list_airbnb_listing_safety_disclosures_response_200.additional_properties = d
        return list_airbnb_listing_safety_disclosures_response_200
