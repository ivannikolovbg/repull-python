...
from ..models.listing_updated_event_event import ListingUpdatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.listing_updated_payload import ListingUpdatedPayload
...
T = TypeVar("T", bound="ListingUpdatedEvent")



@_attrs_define
class ListingUpdatedEvent:
    """ 
        Attributes:
            event (ListingUpdatedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: ListingUpdatedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: ListingUpdatedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ListingUpdatedEventEvent(d.pop("event"))
        ...
        data = ListingUpdatedPayload.from_dict(d.pop("data"))
        ...
        listing_updated_event.additional_properties = d
        return listing_updated_event
