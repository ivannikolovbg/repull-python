...
T = TypeVar("T", bound="GetV1PropertiesResponse200")



@_attrs_define
class GetV1PropertiesResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v1_properties_response_200 = cls(
            data=data,
            pagination=pagination,
        )


        get_v1_properties_response_200.additional_properties = d
        return get_v1_properties_response_200
