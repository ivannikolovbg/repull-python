...
from ..models.reservation_alteration_responded_event_event import ReservationAlterationRespondedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.reservation_alteration_responded_payload import ReservationAlterationRespondedPayload
...
T = TypeVar("T", bound="ReservationAlterationRespondedEvent")



@_attrs_define
class ReservationAlterationRespondedEvent:
    """ 
        Attributes:
            event (ReservationAlterationRespondedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (ReservationAlterationRespondedPayload): Payload for `reservation.alteration.responded`. A pending
                alteration was accepted, declined, or cancelled. `data.object.status` reflects the new state.
    ...
    event: ReservationAlterationRespondedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: ReservationAlterationRespondedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ReservationAlterationRespondedEventEvent(d.pop("event"))
        ...
        data = ReservationAlterationRespondedPayload.from_dict(d.pop("data"))
        ...
        reservation_alteration_responded_event = cls(
            event=event,
            event_id=event_id,
        ...
        reservation_alteration_responded_event.additional_properties = d
        return reservation_alteration_responded_event
