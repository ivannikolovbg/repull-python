...
if TYPE_CHECKING:
  ...
  from ..models.migration_completed_event import MigrationCompletedEvent
...
class WebhookDeliveryDetail:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.payload, Unset):
            ...
            payload = self.payload.to_dict()
        elif isinstance(self.payload, UsageQuotaWarningEvent):
            payload = self.payload.to_dict()
        elif isinstance(self.payload, MigrationCompletedEvent):
            payload = self.payload.to_dict()
        else:
            payload = self.payload.to_dict()
