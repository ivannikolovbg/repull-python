...
T = TypeVar("T", bound="AvailabilityWriteSettings")



@_attrs_define
class AvailabilityWriteSettings:
    """ At least one field is required. An empty object is rejected rather than silently no-ops — the upstream treats every
    field as optional, so a typo would otherwise return 200 and change nothing.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        availability_write_settings = cls(
            available=available,
            price=price,
        ...
        availability_write_settings.additional_properties = d
        return availability_write_settings
