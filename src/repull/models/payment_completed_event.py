...
from ..models.payment_completed_event_event import PaymentCompletedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.payment_completed_payload import PaymentCompletedPayload
...
T = TypeVar("T", bound="PaymentCompletedEvent")
...
class PaymentCompletedEvent:
    """ 
        Attributes:
            event (PaymentCompletedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: PaymentCompletedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: PaymentCompletedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = PaymentCompletedEventEvent(d.pop("event"))
        ...
        data = PaymentCompletedPayload.from_dict(d.pop("data"))
        ...
        payment_completed_event.additional_properties = d
        return payment_completed_event
