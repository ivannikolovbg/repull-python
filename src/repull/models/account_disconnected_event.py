...
from ..models.account_disconnected_event_event import AccountDisconnectedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.account_disconnected_payload import AccountDisconnectedPayload
...
T = TypeVar("T", bound="AccountDisconnectedEvent")



@_attrs_define
class AccountDisconnectedEvent:
    """ 
        Attributes:
            event (AccountDisconnectedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (AccountDisconnectedPayload): Payload for `account.disconnected`. A PMS or channel connection was revoked,
                expired, or rejected by the upstream provider.
    ...
    event: AccountDisconnectedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = AccountDisconnectedEventEvent(d.pop("event"))
        ...
        data = AccountDisconnectedPayload.from_dict(d.pop("data"))
        ...
        account_disconnected_event = cls(
            event=event,
            event_id=event_id,
        ...
        account_disconnected_event.additional_properties = d
        return account_disconnected_event
