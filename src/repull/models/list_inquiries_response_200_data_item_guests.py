...
T = TypeVar("T", bound="ListInquiriesResponse200DataItemGuests")



@_attrs_define
class ListInquiriesResponse200DataItemGuests:
    """ 
        Attributes:
            total (int | None | Unset):  Example: 2.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_inquiries_response_200_data_item_guests = cls(
            total=total,
            adults=adults,
            children=children,
            infants=infants,
        ...
        list_inquiries_response_200_data_item_guests.additional_properties = d
        return list_inquiries_response_200_data_item_guests
