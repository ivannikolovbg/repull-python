...
T = TypeVar("T", bound="AirbnbReservationListResponse")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = AirbnbReservation.from_dict(data_item_data)
        ...
        airbnb_reservation_list_response = cls(
            data=data,
            pagination=pagination,
        )


        airbnb_reservation_list_response.additional_properties = d
        return airbnb_reservation_list_response
