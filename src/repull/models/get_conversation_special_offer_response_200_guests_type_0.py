...
T = TypeVar("T", bound="GetConversationSpecialOfferResponse200GuestsType0")



@_attrs_define
class GetConversationSpecialOfferResponse200GuestsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_conversation_special_offer_response_200_guests_type_0 = cls(
            total=total,
            adults=adults,
            children=children,
            infants=infants,
        ...
        get_conversation_special_offer_response_200_guests_type_0.additional_properties = d
        return get_conversation_special_offer_response_200_guests_type_0
