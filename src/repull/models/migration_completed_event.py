...
from ..models.migration_completed_event_event import MigrationCompletedEventEvent
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="MigrationCompletedEvent")



@_attrs_define
class MigrationCompletedEvent:
    """ An import into a migration workspace finished.

        Attributes:
            event (MigrationCompletedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: MigrationCompletedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = MigrationCompletedEventEvent(d.pop("event"))
        ...
        migration_completed_event.additional_properties = d
        return migration_completed_event
