...
T = TypeVar("T", bound="ReservationGuestDetails")
...
class ReservationGuestDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        reservation_guest_details = cls(
        )


        reservation_guest_details.additional_properties = d
        return reservation_guest_details
