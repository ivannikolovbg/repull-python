...
T = TypeVar("T", bound="GetAirbnbBookingSettingsResponse200DataCancellationNonRefundable")



@_attrs_define
class GetAirbnbBookingSettingsResponse200DataCancellationNonRefundable:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_airbnb_booking_settings_response_200_data_cancellation_non_refundable = cls(
            enabled=enabled,
        ...
        get_airbnb_booking_settings_response_200_data_cancellation_non_refundable.additional_properties = d
        return get_airbnb_booking_settings_response_200_data_cancellation_non_refundable
