...
if TYPE_CHECKING:
  ...
  from ..models.list_airbnb_listing_rooms_response_200_data_item import ListAirbnbListingRoomsResponse200DataItem





T = TypeVar("T", bound="ListAirbnbListingRoomsResponse200")



@_attrs_define
class ListAirbnbListingRoomsResponse200:
    """ 
        Attributes:
            data (list[ListAirbnbListingRoomsResponse200DataItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = ListAirbnbListingRoomsResponse200DataItem.from_dict(data_item_data)
        ...
        list_airbnb_listing_rooms_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        list_airbnb_listing_rooms_response_200.additional_properties = d
        return list_airbnb_listing_rooms_response_200
