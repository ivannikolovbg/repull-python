...
T = TypeVar("T", bound="ListingWebhookObjectAddress")



@_attrs_define
class ListingWebhookObjectAddress:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        listing_webhook_object_address = cls(
            street=street,
            city=city,
            region=region,
        )
        ...
        listing_webhook_object_address.additional_properties = d
        return listing_webhook_object_address
