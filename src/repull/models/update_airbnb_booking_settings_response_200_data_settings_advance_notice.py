...
T = TypeVar("T", bound="UpdateAirbnbBookingSettingsResponse200DataSettingsAdvanceNotice")



@_attrs_define
class UpdateAirbnbBookingSettingsResponse200DataSettingsAdvanceNotice:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_airbnb_booking_settings_response_200_data_settings_advance_notice = cls(
            hours=hours,
        ...
        update_airbnb_booking_settings_response_200_data_settings_advance_notice.additional_properties = d
        return update_airbnb_booking_settings_response_200_data_settings_advance_notice
