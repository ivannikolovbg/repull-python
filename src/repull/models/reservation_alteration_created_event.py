...
from ..models.reservation_alteration_created_event_event import ReservationAlterationCreatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.reservation_alteration_created_payload import ReservationAlterationCreatedPayload
...
T = TypeVar("T", bound="ReservationAlterationCreatedEvent")



@_attrs_define
class ReservationAlterationCreatedEvent:
    """ 
        Attributes:
            event (ReservationAlterationCreatedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (ReservationAlterationCreatedPayload): Payload for `reservation.alteration.created`. A new reservation
                alteration was requested (Airbnb). `data.object` carries the snapshot; `data.changes` lists the requested field
                deltas.
    ...
    event: ReservationAlterationCreatedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: ReservationAlterationCreatedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ReservationAlterationCreatedEventEvent(d.pop("event"))
        ...
        data = ReservationAlterationCreatedPayload.from_dict(d.pop("data"))
        ...
        reservation_alteration_created_event = cls(
            event=event,
            event_id=event_id,
        ...
        reservation_alteration_created_event.additional_properties = d
        return reservation_alteration_created_event
