...
if TYPE_CHECKING:
  ...
  from ..models.get_airbnb_booking_settings_response_200_data import GetAirbnbBookingSettingsResponse200Data





T = TypeVar("T", bound="GetAirbnbBookingSettingsResponse200")



@_attrs_define
class GetAirbnbBookingSettingsResponse200:
    """ 
        Attributes:
            data (GetAirbnbBookingSettingsResponse200Data):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.get_airbnb_booking_settings_response_200_data import GetAirbnbBookingSettingsResponse200Data
        d = dict(src_dict)
        data = GetAirbnbBookingSettingsResponse200Data.from_dict(d.pop("data"))
        ...
        get_airbnb_booking_settings_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        get_airbnb_booking_settings_response_200.additional_properties = d
        return get_airbnb_booking_settings_response_200
