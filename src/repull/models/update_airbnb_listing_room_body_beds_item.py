...
T = TypeVar("T", bound="UpdateAirbnbListingRoomBodyBedsItem")



@_attrs_define
class UpdateAirbnbListingRoomBodyBedsItem:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_airbnb_listing_room_body_beds_item = cls(
            type_=type_,
            quantity=quantity,
        )

        return update_airbnb_listing_room_body_beds_item
