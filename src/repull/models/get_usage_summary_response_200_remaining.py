...
T = TypeVar("T", bound="GetUsageSummaryResponse200Remaining")



@_attrs_define
class GetUsageSummaryResponse200Remaining:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_summary_response_200_remaining.additional_properties = d
        return get_usage_summary_response_200_remaining
