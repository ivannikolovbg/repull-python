...
T = TypeVar("T", bound="CustomSchemaSummary")



@_attrs_define
class CustomSchemaSummary:
    """ List-row shape returned by `GET /v1/schema/custom`. Same fields as `CustomSchema` minus heavy nested data — kept
    identical today; reserved as a separate schema so the list shape can shrink without breaking the detail call.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_schema_summary.additional_properties = d
        return custom_schema_summary
