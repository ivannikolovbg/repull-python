...
T = TypeVar("T", bound="VrboListingListResponse")



@_attrs_define
class VrboListingListResponse:
    """ 
        Attributes:
            data (list[VrboListing] | Unset):
    ...
    data: list[VrboListing] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = VrboListing.from_dict(data_item_data)
        ...
        vrbo_listing_list_response = cls(
            data=data,
            pagination=pagination,
        )


        vrbo_listing_list_response.additional_properties = d
        return vrbo_listing_list_response
