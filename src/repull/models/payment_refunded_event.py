...
from ..models.payment_refunded_event_type import PaymentRefundedEventType
from ..types import UNSET, Unset
...
class PaymentRefundedEvent:
    """ 
        Attributes:
            type_ (PaymentRefundedEventType):
            data (PaymentRefundedPayload): Payload for `payment.refunded`. A previous payment was refunded in part or in
                full.
            id (UUID | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.payment_refunded_payload import PaymentRefundedPayload
        d = dict(src_dict)
        type_ = PaymentRefundedEventType(d.pop("type"))
