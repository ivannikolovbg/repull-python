...
T = TypeVar("T", bound="CreateConversationSpecialOfferResponse201GuestsType0")



@_attrs_define
class CreateConversationSpecialOfferResponse201GuestsType0:
    """ Guests on the offer. Airbnb counts adults + children as guests; infants and pets are extra.

        Attributes:
            total (int | None | Unset):  Example: 3.
            adults (int | None | Unset):  Example: 2.
            children (int | None | Unset):  Example: 1.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_conversation_special_offer_response_201_guests_type_0 = cls(
            total=total,
            adults=adults,
            children=children,
            infants=infants,
        ...
        create_conversation_special_offer_response_201_guests_type_0.additional_properties = d
        return create_conversation_special_offer_response_201_guests_type_0
