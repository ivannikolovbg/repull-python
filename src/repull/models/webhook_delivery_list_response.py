...
T = TypeVar("T", bound="WebhookDeliveryListResponse")
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = WebhookDelivery.from_dict(data_item_data)
        ...
        webhook_delivery_list_response = cls(
            data=data,
            pagination=pagination,
        )


        webhook_delivery_list_response.additional_properties = d
        return webhook_delivery_list_response
