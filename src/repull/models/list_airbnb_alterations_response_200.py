...
T = TypeVar("T", bound="ListAirbnbAlterationsResponse200")



@_attrs_define
class ListAirbnbAlterationsResponse200:
    """ 
        Attributes:
            data (list[AirbnbAlteration]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = AirbnbAlteration.from_dict(data_item_data)
        ...
        list_airbnb_alterations_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        list_airbnb_alterations_response_200.additional_properties = d
        return list_airbnb_alterations_response_200
