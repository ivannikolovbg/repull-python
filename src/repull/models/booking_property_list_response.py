...
T = TypeVar("T", bound="BookingPropertyListResponse")



@_attrs_define
class BookingPropertyListResponse:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = BookingProperty.from_dict(data_item_data)
        ...
        booking_property_list_response = cls(
            data=data,
            pagination=pagination,
        )


        booking_property_list_response.additional_properties = d
        return booking_property_list_response
