...
from ..models.listing_deleted_event_event import ListingDeletedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.listing_deleted_payload import ListingDeletedPayload
...
T = TypeVar("T", bound="ListingDeletedEvent")



@_attrs_define
class ListingDeletedEvent:
    """ 
        Attributes:
            event (ListingDeletedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: ListingDeletedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: ListingDeletedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ListingDeletedEventEvent(d.pop("event"))
        ...
        data = ListingDeletedPayload.from_dict(d.pop("data"))
        ...
        listing_deleted_event.additional_properties = d
        return listing_deleted_event
