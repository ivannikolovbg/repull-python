...
T = TypeVar("T", bound="CreateConversationSpecialOfferResponse201")
...
class CreateConversationSpecialOfferResponse201:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.guests, Unset):
            guests = UNSET
        elif isinstance(self.guests, CreateConversationSpecialOfferResponse201GuestsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_guests(data: object) -> CreateConversationSpecialOfferResponse201GuestsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                guests_type_0 = CreateConversationSpecialOfferResponse201GuestsType0.from_dict(data)
        ...
        create_conversation_special_offer_response_201 = cls(
            id=id,
        ...
        create_conversation_special_offer_response_201.additional_properties = d
        return create_conversation_special_offer_response_201
