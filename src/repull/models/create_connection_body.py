...
T = TypeVar("T", bound="CreateConnectionBody")
...
class CreateConnectionBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        access_type: CreateConnectionBodyAccessType | Unset
        if isinstance(_access_type,  Unset):
            access_type = UNSET
        else:
            access_type = CreateConnectionBodyAccessType(_access_type)
        ...
        create_connection_body.additional_properties = d
        return create_connection_body
