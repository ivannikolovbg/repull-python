...
if TYPE_CHECKING:
  ...
  from ..models.airbnb_listing_details_response import AirbnbListingDetailsResponse





T = TypeVar("T", bound="GetAirbnbListingDetailsResponse200")



@_attrs_define
class GetAirbnbListingDetailsResponse200:
    """ 
        Attributes:
            data (list[AirbnbListingDetailsResponse]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = AirbnbListingDetailsResponse.from_dict(data_item_data)
        ...
        get_airbnb_listing_details_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        get_airbnb_listing_details_response_200.additional_properties = d
        return get_airbnb_listing_details_response_200
