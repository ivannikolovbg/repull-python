...
T = TypeVar("T", bound="ListAirbnbTransactionsResponse200")
...
class ListAirbnbTransactionsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_airbnb_transactions_response_200.additional_properties = d
        return list_airbnb_transactions_response_200
