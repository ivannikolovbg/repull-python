...
T = TypeVar("T", bound="InquiryCreatedPayload")



@_attrs_define
class InquiryCreatedPayload:
    """ Payload for `inquiry.created`. A guest asked about dates.
        ...
        Attributes:
            ...
            revision (datetime.datetime | None | Unset): The inquiry's `updatedAt`.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inquiry_created_payload.additional_properties = d
        return inquiry_created_payload
