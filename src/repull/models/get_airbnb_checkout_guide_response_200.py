...
if TYPE_CHECKING:
  ...
  from ..models.get_airbnb_checkout_guide_response_200_data_item import GetAirbnbCheckoutGuideResponse200DataItem





T = TypeVar("T", bound="GetAirbnbCheckoutGuideResponse200")



@_attrs_define
class GetAirbnbCheckoutGuideResponse200:
    """ 
        Attributes:
            data (list[GetAirbnbCheckoutGuideResponse200DataItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in (_data):
            data_item = GetAirbnbCheckoutGuideResponse200DataItem.from_dict(data_item_data)
        ...
        get_airbnb_checkout_guide_response_200 = cls(
            data=data,
            data_freshness=data_freshness,
        )


        get_airbnb_checkout_guide_response_200.additional_properties = d
        return get_airbnb_checkout_guide_response_200
