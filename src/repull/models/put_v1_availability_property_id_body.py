...
T = TypeVar("T", bound="PutV1AvailabilityPropertyIdBody")



@_attrs_define
class PutV1AvailabilityPropertyIdBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_v1_availability_property_id_body = cls(
            dates=dates,
        )


        put_v1_availability_property_id_body.additional_properties = d
        return put_v1_availability_property_id_body
