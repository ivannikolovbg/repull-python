...
from ..models.ai_operation_completed_event_event import AiOperationCompletedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.ai_operation_completed_payload import AiOperationCompletedPayload
...
T = TypeVar("T", bound="AiOperationCompletedEvent")



@_attrs_define
class AiOperationCompletedEvent:
    """ 
        Attributes:
            event (AiOperationCompletedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (AiOperationCompletedPayload): Payload for `ai.operation.completed`. An async AI run (review response,
                message draft, pricing suggestion) finished.
    ...
    event: AiOperationCompletedEventEvent
    event_id: UUID
    api_version: str
    timestamp: datetime.datetime
    data: AiOperationCompletedPayload
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = AiOperationCompletedEventEvent(d.pop("event"))
        ...
        data = AiOperationCompletedPayload.from_dict(d.pop("data"))
        ...
        ai_operation_completed_event = cls(
            event=event,
            event_id=event_id,
        ...
        ai_operation_completed_event.additional_properties = d
        return ai_operation_completed_event
