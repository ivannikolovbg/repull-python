...
from ..models.listing_reactivated_event_event import ListingReactivatedEventEvent
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="ListingReactivatedEvent")



@_attrs_define
class ListingReactivatedEvent:
    """ 
        Attributes:
            event (ListingReactivatedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: ListingReactivatedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ListingReactivatedEventEvent(d.pop("event"))
        ...
        listing_reactivated_event.additional_properties = d
        return listing_reactivated_event
