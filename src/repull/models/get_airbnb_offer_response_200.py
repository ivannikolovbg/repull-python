...
from ..models.get_airbnb_offer_response_200_offer_type import GetAirbnbOfferResponse200OfferType
from ..models.get_airbnb_offer_response_200_status import GetAirbnbOfferResponse200Status
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.get_airbnb_offer_response_200_guest_details import GetAirbnbOfferResponse200GuestDetails





T = TypeVar("T", bound="GetAirbnbOfferResponse200")



@_attrs_define
class GetAirbnbOfferResponse200:
    ...
    carries only the thread, status and expiry.
        ...
        Attributes:
            ...
            offer_type (GetAirbnbOfferResponse200OfferType | Unset):
            status (GetAirbnbOfferResponse200Status | Unset):
            listing_id (str | Unset): Airbnb listing id (special offers only).
            start_date (datetime.date | Unset):
            nights (int | Unset):
            total_price (float | Unset):
            guest_details (GetAirbnbOfferResponse200GuestDetails | Unset):
    ...
    offer_type: GetAirbnbOfferResponse200OfferType | Unset = UNSET
    status: GetAirbnbOfferResponse200Status | Unset = UNSET
    listing_id: str | Unset = UNSET
    start_date: datetime.date | Unset = UNSET
    nights: int | Unset = UNSET
    total_price: float | Unset = UNSET
    guest_details: GetAirbnbOfferResponse200GuestDetails | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_offer_type,  Unset):
            ...
            offer_type = GetAirbnbOfferResponse200OfferType(_offer_type)
        ...
        if isinstance(_status,  Unset):
            ...
            status = GetAirbnbOfferResponse200Status(_status)
        ...
        if isinstance(_guest_details,  Unset):
            ...
            guest_details = GetAirbnbOfferResponse200GuestDetails.from_dict(_guest_details)
        ...
        get_airbnb_offer_response_200 = cls(
            id=id,
            thread_id=thread_id,
        ...
        get_airbnb_offer_response_200.additional_properties = d
        return get_airbnb_offer_response_200
