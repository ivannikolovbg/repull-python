...
T = TypeVar("T", bound="GetUsageSummaryResponse200Limits")



@_attrs_define
class GetUsageSummaryResponse200Limits:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_summary_response_200_limits.additional_properties = d
        return get_usage_summary_response_200_limits
