...
from ..models.review_responded_event_event import ReviewRespondedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.review_responded_payload import ReviewRespondedPayload
...
T = TypeVar("T", bound="ReviewRespondedEvent")



@_attrs_define
class ReviewRespondedEvent:
    """ 
        Attributes:
            event (ReviewRespondedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (ReviewRespondedPayload): Payload for `review.responded`. A public host response to a review was recorded.
                Fetch the response body via `GET /v1/reviews/{id}`.
    ...
    event: ReviewRespondedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ReviewRespondedEventEvent(d.pop("event"))
        ...
        data = ReviewRespondedPayload.from_dict(d.pop("data"))
        ...
        review_responded_event.additional_properties = d
        return review_responded_event
