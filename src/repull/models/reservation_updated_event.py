...
from ..models.reservation_updated_event_event import ReservationUpdatedEventEvent
from ..types import UNSET, Unset
...
class ReservationUpdatedEvent:
    """ 
        Attributes:
            event (ReservationUpdatedEventEvent): The event name. This field is `event`, not `type`.
    ...
    event: ReservationUpdatedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ReservationUpdatedEventEvent(d.pop("event"))
