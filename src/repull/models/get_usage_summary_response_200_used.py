...
T = TypeVar("T", bound="GetUsageSummaryResponse200Used")



@_attrs_define
class GetUsageSummaryResponse200Used:
    """ 
        Attributes:
            monthly (int | Unset):
            daily_ai (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_summary_response_200_used.additional_properties = d
        return get_usage_summary_response_200_used
