...
T = TypeVar("T", bound="GuestListResponse")



@_attrs_define
class GuestListResponse:
    """ Cursor-paginated guest list. Pass `pagination.next_cursor` back as `?cursor=` to fetch the next page.

        Attributes:
            data (list[Guest] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = Guest.from_dict(data_item_data)
        ...
        guest_list_response = cls(
            data=data,
            pagination=pagination,
        )


        guest_list_response.additional_properties = d
        return guest_list_response
