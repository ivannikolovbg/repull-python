...
from ..models.listing_pricing_strategy_input_comp_position_target import ListingPricingStrategyInputCompPositionTarget
from ..models.listing_pricing_strategy_input_mode import ListingPricingStrategyInputMode
from ..types import UNSET, Unset
from typing import cast

if TYPE_CHECKING:
  from ..models.listing_pricing_strategy_input_day_of_week_multipliers import ListingPricingStrategyInputDayOfWeekMultipliers





T = TypeVar("T", bound="ListingPricingStrategyInput")



@_attrs_define
class ListingPricingStrategyInput:
    """ Same shape as `ListingPricingStrategy` minus the read-only fields. Send only fields you want to change.

        Attributes:
            mode (ListingPricingStrategyInputMode | Unset):
            min_price (float | None | Unset):
            max_price (float | None | Unset):
            max_daily_change_pct (float | Unset):
            weekend_markup_pct (float | None | Unset):
            day_of_week_multipliers (ListingPricingStrategyInputDayOfWeekMultipliers | Unset):
            target_occupancy_pct (float | None | Unset):
            target_monthly_revenue (float | None | Unset):
            owner_min_monthly_payout (float | None | Unset):
            comp_position_target (ListingPricingStrategyInputCompPositionTarget | Unset):
            comp_adjust_pct (float | Unset):
            event_boost_enabled (bool | Unset):
            event_boost_max_pct (float | Unset):
     """

    mode: ListingPricingStrategyInputMode | Unset = UNSET
    min_price: float | None | Unset = UNSET
    max_price: float | None | Unset = UNSET
    max_daily_change_pct: float | Unset = UNSET
    weekend_markup_pct: float | None | Unset = UNSET
    day_of_week_multipliers: ListingPricingStrategyInputDayOfWeekMultipliers | Unset = UNSET
    ...
    comp_position_target: ListingPricingStrategyInputCompPositionTarget | Unset = UNSET
    comp_adjust_pct: float | Unset = UNSET
    event_boost_enabled: bool | Unset = UNSET
    event_boost_max_pct: float | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_mode,  Unset):
            ...
            mode = ListingPricingStrategyInputMode(_mode)
        ...
        if isinstance(_day_of_week_multipliers,  Unset):
            ...
            day_of_week_multipliers = ListingPricingStrategyInputDayOfWeekMultipliers.from_dict(_day_of_week_multipliers)
        ...
        if isinstance(_comp_position_target,  Unset):
            ...
            comp_position_target = ListingPricingStrategyInputCompPositionTarget(_comp_position_target)
        ...
        listing_pricing_strategy_input = cls(
            mode=mode,
            min_price=min_price,
            max_price=max_price,
        ...
        listing_pricing_strategy_input.additional_properties = d
        return listing_pricing_strategy_input
