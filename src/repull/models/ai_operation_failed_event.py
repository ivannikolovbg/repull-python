...
from ..models.ai_operation_failed_event_event import AiOperationFailedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.ai_operation_failed_payload import AiOperationFailedPayload
...
T = TypeVar("T", bound="AiOperationFailedEvent")



@_attrs_define
class AiOperationFailedEvent:
    """ 
        Attributes:
            event (AiOperationFailedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (AiOperationFailedPayload): Payload for `ai.operation.failed`. An async AI run terminated with an error and
                will not be retried.
    ...
    event: AiOperationFailedEventEvent
    event_id: UUID
    api_version: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = AiOperationFailedEventEvent(d.pop("event"))
        ...
        data = AiOperationFailedPayload.from_dict(d.pop("data"))
        ...
        ai_operation_failed_event.additional_properties = d
        return ai_operation_failed_event
