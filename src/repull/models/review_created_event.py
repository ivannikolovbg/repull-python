...
from ..models.review_created_event_event import ReviewCreatedEventEvent
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.review_created_payload import ReviewCreatedPayload
...
T = TypeVar("T", bound="ReviewCreatedEvent")
...
class ReviewCreatedEvent:
    """ 
        Attributes:
            event (ReviewCreatedEventEvent): The event name. This field is `event`, not `type`.
            ...
            data (ReviewCreatedPayload): Payload for `review.created`. A new review was received on a reservation.
                `data.object.reviewerRole` disambiguates guest vs host authorship.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.webhook_event_account_type_0 import WebhookEventAccountType0
        d = dict(src_dict)
        event = ReviewCreatedEventEvent(d.pop("event"))
        ...
        data = ReviewCreatedPayload.from_dict(d.pop("data"))
        ...
        review_created_event.additional_properties = d
        return review_created_event
