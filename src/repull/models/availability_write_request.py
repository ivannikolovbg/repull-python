...
T = TypeVar("T", bound="AvailabilityWriteRequest")



@_attrs_define
class AvailabilityWriteRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        availability_write_request = cls(
            dates=dates,
            available=available,
            price=price,
        ...
        availability_write_request.additional_properties = d
        return availability_write_request
