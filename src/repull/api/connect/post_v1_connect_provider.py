...
from ...models.post_v1_connect_provider_body import PostV1ConnectProviderBody
...
def _get_kwargs(
    provider: str,
    *,
    body: PostV1ConnectProviderBody | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        provider (str):
        body (PostV1ConnectProviderBody | Unset): Provider-specific credentials (apiKey,
