...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/conversations/{id}".format(id=quote(str(id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ConversationDetail | Error | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ConversationDetail | Error]:
    return Response(
